		...
		public GenericCreativityPrompts (string filler, string type, CultureInfo currentCulture)
		{
			...
			if (currentCulture.ToString ().Contains ("en")) {
				...
				if (type.Equals ("NP")) {
					...
					this.genericCPs.Add ("Pensa a fare il contrario di ciò che è previsto con il *" + filler + "*");
					this.genericCPs.Add ("Pensa se puoi sostituire qualcosa di meccanico nel *" + filler + "* con qualcosa che èensoriale");
					this.genericCPs.Add ("Pensa se è possibile modificare la densitàel *" + filler + "*");
					this.genericCPs.Add ("Pensa se è possibile variare la temperatura del *" + filler + "*");
					this.genericCPs.Add ("Pensa a rendere il *" + filler + "* piùlessibile");
					this.genericCPs.Add ("Pensa a come utilizzare liquidi o aria con il *" + filler + "*");
					this.genericCPs.Add ("Pensa se è possibile rigenerare il *" + filler + "*");
					this.genericCPs.Add ("Pensa a come fornire una conchiglia o copertura per il *" + filler + "*");
					this.genericCPs.Add ("Pensa se è possibile fare una copia del *" + filler + "*");
					this.genericCPs.Add ("Pensa a come si potesse combinare il *" + filler + "* con qualcos'altro");
					this.genericCPs.Add ("Pensa se potessi fare di piu' con il *" + filler + "* o di meno con il *" + filler + "*");
					this.genericCPs.Add ("Pensa se è possibile bilanciare il *" + filler + "* con qualcos'altro");
					...
					this.genericCPs.Add ("Pensa a come fare vibrare il *" + filler + "*");
					this.genericCPs.Add ("Pensa se è possibile far in modo che il *" + filler + "* si cambi da solo, rilasci o assorbi energia");
					this.genericCPs.Add ("Pensa se è possibile fare il *" + filler + "* in una forma irregolare");
					this.genericCPs.Add ("Pensa a cercar di mettere il *" + filler + "* all'interno di un'altra cosa, all'interno di un'altra cosa");
					this.genericCPs.Add ("Pensa a rendere il *" + filler + "* più sferico o circolare");
					this.genericCPs.Add ("Pensa a rendere tutte le parti del *" + filler + "* di una sostanza sola");
					this.genericCPs.Add ("Pensa a dividere il *" + filler + "* in");
					this.genericCPs.Add ("Pensa a rendere il  *" + filler + "* trasparente o di un colore diverso");
					this.genericCPs.Add ("Pensa a come di fare in modo che il *" + filler + "* si espanda o contratti  a seconda dell'ambiente");
					this.genericCPs.Add ("Pensa a come mettere buchi nel *" + filler + "* o riempire i buchi nel *" + filler + "*");
					this.genericCPs.Add ("Pensa a rendere il *" + filler + "* a basso costo ed usa e getta");
